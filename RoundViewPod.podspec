...
Pod::Spec.new do |s|
  s.name             = 'RoundViewPod'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RoundViewPod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Yonatan Giventer/RoundViewPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Yonatan Giventer' => 'yonatan.giventer@gmail.com' }
  s.source           = { :git => 'https://github.com/Yonatan Giventer/RoundViewPod.git', :tag => s.version.to_s }
